...
public:
	...
	// Utility
	static eIwGameAdsPortalType	FindPortalType(bool text_ad = false);				// Auto find portal type from OS type and ad type
	static int					getPortalID(eIwGameAdsPortalType type);				// Return portal iD
