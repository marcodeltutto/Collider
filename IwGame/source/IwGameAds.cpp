...
{
	CIwGameString::CalculateHash("OK"), 
	CIwGameString::CalculateHash("House Ad"), 
	CIwGameString::CalculateHash("Internal Error"), 
	CIwGameString::CalculateHash("Invalid Input"), 
	CIwGameString::CalculateHash("Unknown App Id"), 
	CIwGameString::CalculateHash("noAD"), 
};
...
int CIwGameAds::getPortalID(eIwGameAdsPortalType type)
{
