...
void CIwGameHttpManager::Init()
{
	...
	DetermineUserAgent();
//	DetermineIPAddress();	// Some ad providers require an IP address, but this call can cause boot delays on weak networks. If your ad provider requires an IP address then please ensure that this is uncommented
}
