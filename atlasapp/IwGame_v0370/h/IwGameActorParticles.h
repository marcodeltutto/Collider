...
struct CIwGameActorParticle
{
	...
	CIwGameActorParticle() :	Parent(NULL), Visual(NULL), Position(0, 0), Velocity(0, 0), VelocityDamping(1.0f, 1.0f), Scale(1.0f, 1.0f) , ScaleVelocity(0, 0), ScaleVelocityDamping(1.0f, 1.0f), 
								...
								LifeSpan(2), SpawnDelay(0), LifeTime(0), Lives(-1), Visible(false), Active(true), Gravity(0), Depth(0), DepthVelocity(0),DepthVelocityDamping(1)
	{
	}
...
public:
	bool			addParticle(CIwGameActorParticle* particle, CIwRect& src_rect, int count = 0);
