...
public:
	...
	virtual bool		InitTextActor(CIwGameFont* font, CIwRect& rect, CIwGameString& text, int flags, IwGxFontAlignHor align_h, IwGxFontAlignVer align_v, CIwFVec4& skew, CIwRect& text_margin, bool auto_height);
...
{
public:
	enum eIwGameUI_TypeHint
	{
		TypeHint_Text		= 0, 
		TypeHint_Number		= S3E_OSREADSTRING_FLAG_NUMBER, 
		TypeHint_Password	= S3E_OSREADSTRING_FLAG_PASSWORD, 
		TypeHint_Email		= S3E_OSREADSTRING_FLAG_EMAIL, 
		TypeHint_URL		= S3E_OSREADSTRING_FLAG_URL
	};
...
protected:
	...
	eIwGameUI_TypeHint	TypeHint;							// Hint to which type of data user should enter
public:
	...
	void				setTypeHint(eIwGameUI_TypeHint hint)			{ TypeHint = hint; }
	eIwGameUI_TypeHint	getTypeHint() const								{ return TypeHint; }
	bool				setProperty(unsigned int element_name, CIwGameString& data, bool delta);
	// Properties end
protected:
	bool				UpdateBinding(unsigned int element_name, CIwGameXomlVariable* var);
