...
options["cmdline"]=['/Applications/Marmalade.app/Contents/s3e/makefile_builder/mkb.py', '/Users/deltutto/My_Collider/atlasapp/GameSceneGL.mkb', '--buildenv=XCODE', '--debug', '--arm', '--compiler=gcc', '--deploy-only']
...
t["<config>"]="Default"
t["os"]="android"
t["endDir"]="/Users/deltutto/My_Collider/atlasapp/build_gamescenegl_xcode/deployments/default/android/release/arm"
