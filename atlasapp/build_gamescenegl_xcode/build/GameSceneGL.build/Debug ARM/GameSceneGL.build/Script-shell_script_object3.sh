...
s3e_plink --license "/Users/deltutto/My_Collider/atlasapp/build_gamescenegl_xcode/build/${CONFIGURATION}${EFFECTIVE_PLATFORM_NAME}/GameSceneGL.s86" --buildenv=XCODE_7.3 --arch=x86 --config=debug
