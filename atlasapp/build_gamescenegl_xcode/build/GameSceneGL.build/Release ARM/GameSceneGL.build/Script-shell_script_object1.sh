...
/usr/bin/python ./postlink.py "${TARGET_BUILD_DIR}/${EXECUTABLE_NAME}" "/Users/deltutto/My_Collider/atlasapp/build_gamescenegl_xcode/build/${CONFIGURATION}${EFFECTIVE_PLATFORM_NAME}/GameSceneGL.s86"
