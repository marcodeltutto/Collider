...
config = {}
cmdline = ['/Applications/Marmalade.app/Contents/s3e/makefile_builder/mkb.py', '/Users/deltutto/My_Collider/atlasapp/GameSceneGL.mkb', '--buildenv=XCODE', '--release', '--arm', '--compiler=gcc', '--no-ide', '--make', '--hub-data', '/Users/deltutto/My_Collider/atlasapp/project_GameSceneGL/mkb-build.txt', '--deploy-only']
