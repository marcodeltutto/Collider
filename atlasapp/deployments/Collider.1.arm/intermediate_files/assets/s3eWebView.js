...
function _iOSSetup()
{
    ...
    s3e.exec = function(jsonString)
    {
        if (typeof window != "undefined" && typeof window.webkit != "undefined" &&
            ...
            typeof window.webkit.messageHandlers.s3ebridge != "undefined")
        {
            // WKWebView setup
            var dataToSend = '!' + jsonString.length + '!' + jsonString;
            window.webkit.messageHandlers.s3ebridge.postMessage(dataToSend);
        }
        else
        {
            if (s3e.queue == null)
