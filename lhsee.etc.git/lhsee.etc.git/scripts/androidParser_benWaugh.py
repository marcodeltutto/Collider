...
def AddToAndroidList(new_file_uri,list_uri,MAX_EVENTS,dest_dir,full_path):
    try:
...
def UpdateAndroidXMLFiles(src_dir,dest_dir,list_uri,external_path,MAX_EVENTS,logger):
    #XML files in src
    #logger.info("Entering UpdateAndroidXMLFiles: "+src_file_uri)
